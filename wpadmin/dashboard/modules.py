...
"""
Module where wpadmin dashboard modules classes are defined.
"""
...
# WPADMIN IMPORTS
from wpadmin.dashboard.utils import AppListElementMixin
...
class DashboardModule(object):
    ...
    ``template``
        ...
        Default value: 'wpadmin/dashboard/module.html'.
    """

    template = 'wpadmin/dashboard/module.html'
    collapsible = True
    column = None
    show_title = True
    title = ''
    ...
    def init_with_context(self, context):
        """
        Like for the :class:`~wpadmin.dashboard.Dashboard` class, dashboard
    ...
    def render_css_classes(self):
        ...
        ret = ['wpadmin-dashboard-module']
        if self.collapsible:
            ret.append('wpadmin-collapse')
            if "wpadmin-open" not in self.css_classes and "wpadmin-closed" not in self.css_classes:
                ret.append('wpadmin-open')
...
class Group(DashboardModule):
    ...
    Here's an example of modules group::
        ...
        from wpadmin.dashboard import modules, Dashboard
    ...
    template = 'wpadmin/dashboard/modules/group.html'
...
class LinkList(DashboardModule):
    ...
    title = _('Links')
    template = 'wpadmin/dashboard/modules/link_list.html'
...
class AppList(DashboardModule, AppListElementMixin):
    ...
    template = 'wpadmin/dashboard/modules/app_list.html'
    models = None
    exclude = None
...
class ModelList(DashboardModule, AppListElementMixin):
    ...
    template = 'wpadmin/dashboard/modules/model_list.html'
    models = None
    exclude = None
...
class RecentActions(DashboardModule):
    ...
    template = 'wpadmin/dashboard/modules/recent_actions.html'
    limit = 10
    include_list = None
    exclude_list = None
...
class Feed(DashboardModule):
    ...
    title = _('RSS Feed')
    template = 'wpadmin/dashboard/modules/feed.html'
    feed_url = None
    limit = None
